...
$classes = ($active ?? false)
            ...
            : 'inline-flex items-center px-3 py-2 text-sm font-medium text-primary-600 rounded-md hover:text-primary-900 hover:bg-primary-50 transition-colors duration-150 dark:text-accent-400 dark:hover:text-accent-100 dark:hover:bg-accent-800';
@endphp
