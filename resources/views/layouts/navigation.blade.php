                            ...
                            <div class="overflow-hidden rounded-2xl shadow-xl ring-1 ring-black/5 dark:ring-white/10 surface-sem p-6">
                                <div class="grid grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-3">
                                            @can('monitoring.view')
                                            <a href="{{ route('monitoring.environment.index') }}" class="group flex items-start p-3 -m-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/30 transition duration-150">
                                                ...
                                                <div class="ml-4">
                                                    <p class="text-sm font-medium text-gray-900 dark:text-white group-hover:text-blue-700 dark:group-hover:text-blue-400">Log Suhu & Kelembaban</p>
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">Pencatatan harian</p>
                                                </div>
                                            </a>
                                            @endcan
                                            ...
                                            @can('qmh.view')
                                            <a href="{{ route('quality.index') }}" class="group flex items-start p-3 -m-3 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/30 transition duration-150 {{ request()->routeIs('quality.*') ? 'bg-teal-50 dark:bg-teal-900/20 rounded-lg' : '' }}">
                                                ...
                                                <div class="ml-4">
                                                    <p class="text-sm font-medium text-gray-900 dark:text-white group-hover:text-teal-700 dark:group-hover:text-teal-400">Dashboard QMH</p>
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">Hub dokumen mutu dan metrik utama</p>
                                                </div>
                                            </a>
                                            @endcan
                                            ...
                                            @canany(['analysts.view', 'settings.view'])
                                                ...
                                                @can('manage-settings')
                                                <a href="{{ route('whatsapp.index') }}" class="group flex items-center p-2 rounded-md hover:bg-green-50 dark:hover:bg-green-900/20 transition duration-150 {{ request()->routeIs('whatsapp.*') ? 'bg-green-100 dark:bg-green-900/30 ring-1 ring-green-200 dark:ring-green-800' : '' }}">
                                                    <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/></svg>
                                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">WhatsApp Hub</span>
                                                </a>
                                                
                                                {{-- Old links redirected to Hub
                                                <a href="{{ route('reminders.index') }}" class="group flex items-center p-2 rounded-md hover:bg-green-50 dark:hover:bg-green-900/20 transition duration-150">
                                                    <svg class="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Reminders (Bot)</span>
                                                </a>

                                                <a href="{{ route('broadcasts.index') }}" class="group flex items-center p-2 rounded-md hover:bg-green-50 dark:hover:bg-green-900/20 transition duration-150">
                                                    ...
                                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Broadcast WA</span>
                                                </a>
                                                --}}
                                                @endcan
                                            @endcanany
                ...
                @auth
                    ...
                    <div x-data="{ refExpanded: false }" class="space-y-1">
                        ...
                        <div x-show="refExpanded" id="mobile-ref-section" class="pl-4 space-y-1" style="display: none;">
                            ...
                            @endcan
                            @can('qmh.view')
                            <x-responsive-nav-link href="{{ route('quality.index') }}" :active="request()->routeIs('quality.*')">Dashboard QMH</x-responsive-nav-link>
                            @endcan
                            @can('changelogs.view')
                        ...
                        @endcanany
                            ...
                            <x-responsive-nav-link href="{{ route('whatsapp.index') }}" :active="request()->routeIs('whatsapp.*')">WhatsApp Hub</x-responsive-nav-link>
                            @endcan
                        </div>
                    </div>
                @endauth
