        ...
        >
            <x-slot name="actions">
                <a href="{{ route('analysts.create') }}"
                    class="inline-flex items-center rounded-md bg-primary-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-primary-700">Tambah Staff</a>
            </x-slot>
        </x-page-header>
    </x-slot>

    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <p class="text-sm text-gray-600">Kelola akun staff laboratorium, termasuk gelar, pangkat, dan nomor identitas.</p>
        ...
        <x-page-section title="Daftar Staff">
            <div class="overflow-hidden rounded-lg bg-white shadow-sm">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 text-sm text-gray-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-4 py-6 text-center text-gray-500">Belum ada data staff.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
