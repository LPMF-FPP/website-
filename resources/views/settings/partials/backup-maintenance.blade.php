...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <div class="p-6 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-500 mt-1">Sistem backup darurat untuk kebutuhan pre-deployment</p>
    </div>
    <div class="p-6 space-y-6">
        
        {{-- Emergency Backup Button --}}
        <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
            <h3 class="text-sm font-semibold text-gray-700 mb-3">Backup Darurat</h3>
            ...
            <button 
                ...
                <span x-show="!client.state.backupRunning">Backup Darurat Sekarang</span>
        ...
        <div class="border border-gray-200 rounded-lg">
            <div class="p-4 bg-gray-50 border-b border-gray-200">
                <h3 class="text-sm font-semibold text-gray-700">Backup Terakhir</h3>
            </div>
            <div class="divide-y divide-gray-200">
                <template x-if="client.state.backups.length === 0">
                    <div class="p-4 text-sm text-gray-500 text-center">Belum ada backup</div>
                </template>
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <div class="mt-1 flex items-center gap-4 text-xs text-gray-500">
                                    <span x-text="`Ukuran: ${backup.size}`"></span>
                                    <span x-show="backup.git_commit" x-text="`Git: ${backup.git_commit}`"></span>
                                    <span x-show="backup.triggered_by" x-text="`Oleh: ${backup.triggered_by}`"></span>
                                </div>
