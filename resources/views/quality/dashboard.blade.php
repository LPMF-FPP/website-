            ...
            <div class="mb-6 rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                <form method="GET" action="{{ route('quality.index') }}" class="grid gap-3 md:grid-cols-2 lg:grid-cols-5">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('quality.index') }}" class="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Reset</a>
                    </div>
                </form>
            </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500" x-text="globalPulseLabel()"></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500" x-text="`${totalOverdue()} dokumen overdue perlu ditindaklanjuti`"></p>
                                </div>
                            </div>
                        </div>

                        <div class="mt-6 border-t border-gray-100 pt-4">
                            <a href="{{ route('quality.documents.index', ['status' => 'in_review']) }}" class="flex w-full items-center justify-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50">
                                Cek Status Lengkap
                            </a>
                        </div>
                    </div>
