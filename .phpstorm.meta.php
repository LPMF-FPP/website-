...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.slow_query_threshold_ms' => 'integer',
            'document-templates.default_render_engine' => 'string',
            'document-templates.preview_rate_limit' => 'integer',
            'document-templates.allowed_asset_hosts' => 'array',
            ...
            'filesystems.disks.documents.url' => 'string',
            'filesystems.disks.documents.visibility' => 'string',
            'filesystems.disks.documents.throw' => 'boolean',
            'filesystems.disks.documents.report' => 'boolean',
            'filesystems.disks.samples.driver' => 'string',
            'filesystems.disks.samples.root' => 'string',
            'filesystems.disks.samples.url' => 'string',
            'filesystems.disks.samples.visibility' => 'string',
            'filesystems.disks.samples.throw' => 'boolean',
            'filesystems.disks.samples.report' => 'boolean',
            'filesystems.links./home/lpmf-dev/website-/public/storage' => 'string',
            'filesystems.links./home/lpmf-dev/website-/public/storage/samples' => 'string',
            ...
            'search.enforce_search_policy' => 'boolean',
            'search.enforce_download_policy' => 'boolean',
            'search.doc_types' => 'array',
            'search.doc_type_labels.all' => 'string',
            'search.doc_type_labels.sample_photo' => 'string',
            'search.doc_type_labels.ba_penerimaan' => 'string',
            'search.doc_type_labels.ba_penyerahan' => 'string',
            'search.doc_type_labels.request_letter' => 'string',
            'search.doc_type_labels.bap' => 'string',
            'search.doc_type_labels.ba' => 'string',
            'search.documents_disk' => 'string',
            'search.photos_disk' => 'string',
            'search.people_cases_limit' => 'integer',
            'sentry.dsn' => 'NULL',
            'sentry.release' => 'NULL',
            ...
            'services.whatsapp.gowa.base_url' => 'NULL',
            'services.whatsapp.gowa.username' => 'NULL',
            'services.whatsapp.gowa.password' => 'NULL',
            'services.whatsapp.gowa.timeout' => 'integer',
            'services.whatsapp.gowa.retry_times' => 'integer',
            'services.whatsapp.gowa.retry_sleep' => 'integer',
            'services.s3.timeout' => 'integer',
            'services.s3.connect_timeout' => 'integer',
            'services.monitoring.sentry.dsn' => 'NULL',
            'services.monitoring.sentry.traces_sample_rate' => 'double',
            'services.monitoring.sentry.environment' => 'string',
            'services.monitoring.flare.key' => 'NULL',
...
'viewPulse','manage-settings','manage-users','issue-number','viewTelescope',
'viewAny','view','download','viewDocuments','uploadDocument',
'delete','restore','forceDelete','createDocuments','deleteDocuments',);
...
'database.connections.pgsql.prefix_indexes','database.connections.pgsql.search_path','database.connections.pgsql.sslmode','database.connections.pgsql.schema','database.connections.sqlsrv.driver',
...
'database.slow_query_threshold_ms','document-templates.default_render_engine','document-templates.preview_rate_limit','document-templates.allowed_asset_hosts','dompdf.show_warnings',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.documents.driver','filesystems.disks.documents.root','filesystems.disks.documents.url',
'filesystems.disks.documents.visibility','filesystems.disks.documents.throw','filesystems.disks.documents.report','filesystems.disks.samples.driver','filesystems.disks.samples.root',
'filesystems.disks.samples.url','filesystems.disks.samples.visibility','filesystems.disks.samples.throw','filesystems.disks.samples.report','filesystems.links./home/lpmf-dev/website-/public/storage',
'filesystems.links./home/lpmf-dev/website-/public/storage/samples','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'logging.channels.sentry.driver','logging.channels.sentry_logs.driver','logging.channels.sentry_logs.level','mail.default','mail.mailers.smtp.transport',
...
'queue.failed.driver','queue.failed.database','queue.failed.table','search.enforce_search_policy','search.enforce_download_policy',
'search.doc_types','search.doc_type_labels.all','search.doc_type_labels.sample_photo','search.doc_type_labels.ba_penerimaan','search.doc_type_labels.ba_penyerahan',
'search.doc_type_labels.request_letter','search.doc_type_labels.bap','search.doc_type_labels.ba','search.documents_disk','search.photos_disk',
'search.people_cases_limit','sentry.dsn','sentry.release','sentry.environment','sentry.sample_rate',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.whatsapp.base_url','services.whatsapp.api_key',
'services.whatsapp.gowa.base_url','services.whatsapp.gowa.username','services.whatsapp.gowa.password','services.whatsapp.gowa.timeout','services.whatsapp.gowa.retry_times',
'services.whatsapp.gowa.retry_sleep','services.s3.timeout','services.s3.connect_timeout','services.monitoring.sentry.dsn','services.monitoring.sentry.traces_sample_rate',
'services.monitoring.sentry.environment','services.monitoring.flare.key','session.driver','session.lifetime','session.expire_on_close',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'livewire.pagination_theme','livewire.release_token','excel.exports.chunk_size','excel.exports.pre_calculate_formulas','excel.exports.strict_null_comparison',
...
'signed','throttle','verified','audit.activity',);
        registerArgumentsSet('routes', 
'dusk.login','dusk.logout','dusk.user','pulse','telescope','livewire.update','livewire.upload-file','livewire.preview-file','whatsapp.webhook','document-templates.index','document-templates.by-type','document-templates.show','document-templates.store',
'document-templates.upload','document-templates.activate','document-templates.deactivate','document-templates.update','document-templates.preview',
'document-templates.preview-html','document-templates.preview-pdf','document-templates.update-content','document-templates.destroy','blade-templates.index','blade-templates.show',
'blade-templates.update','blade-templates.preview','blade-templates.backups','blade-templates.restore','api.search','api.people.show','api.documents.show','api.documents.download','locale.switch','health','health.liveness','health.readiness','public.tracking','public.track','public.tracking.json','dashboard',
'dashboard.stats','search.index','search.data','search.suggest','profile.edit',
'profile.update','profile.destroy','requests.index','requests.create','requests.store',
'requests.show','requests.edit','requests.update','requests.destroy','requests.documents.download',
'requests.documents.delete','requests.berita-acara.check','requests.berita-acara.generate','requests.berita-acara.download','requests.berita-acara.view',
'review.create','review.store','review.reject','review.show','testing.index','testing.processes.create',
'testing.processes.store','testing.processes.edit','testing.processes.update','testing.processes.destroy','testing.processes.generate-form',
'testing.processes.lab-report','testing.processes.show','testing.recent','testing.request-processes.store','testing.ready-for-delivery',
'testing.show','sample-processes.index','sample-processes.create',
'sample-processes.generate-form','sample-processes.lab-report','sample-processes.edit','sample-processes.show','sample-processes.store',
'sample-processes.update','sample-processes.destroy','samples.ready-for-delivery','analysts.logs','analysts.role.update',
'analysts.disable','analysts.enable','analysts.index','analysts.create','analysts.store',
'analysts.show','analysts.edit','analysts.update','analysts.destroy','delivery.index',
'delivery.show','delivery.complete','delivery.handover.generate','delivery.handover.view','delivery.handover.download',
'delivery.handover.status','delivery.survey','delivery.survey.submit','tracking.index','tracking.store',
'changelogs.index','statistics.index','statistics.data','statistics.export','reports.surveys.export',
'reports.monthly-logs','reports.monthly-logs.environment','reports.monthly-logs.instrument','reports.monthly-logs.weighing','monitoring.sensors.index',
'monitoring.environment.index','monitoring.environment.readings.store','monitoring.environment.readings.correction','monitoring.environment.readings.correction.store','monitoring.environment.manage',
'monitoring.environment.locations.index','monitoring.environment.locations.store','monitoring.environment.locations.update','monitoring.environment.locations.destroy','monitoring.instruments.index',
'api.samples.instrument-requirements','api.samples.instrument-usage','api.samples.uvvis-weighing.check','api.samples.uvvis-weighing.store','api.samples.weighing.check',
'api.samples.weighing.store','settings.index','settings.show','settings.update','settings.preview',
'settings.test','settings.brand.upload','settings.instrument-requirements.save','settings.templates.index','settings.templates.store',
'settings.templates.activate','settings.blade-templates','settings.document-templates','numbering.preview','numbering.issue',
'investigator.documents.index','investigator.documents.create','investigator.documents.store','investigator.documents.show','investigator.documents.download',
'investigator.documents.destroy','inventory.dashboard','inventory.items.index','inventory.items.create','inventory.items.store',
'inventory.items.edit','inventory.items.update','inventory.items.destroy','inventory.items.lots','inventory.lots.store',
'inventory.locations.index','inventory.locations.create','inventory.locations.store','inventory.locations.edit','inventory.locations.update',
'inventory.stock-card','inventory.stock-card.print','inventory.transaction.receipt','inventory.transaction.','inventory.transaction.issue',
'inventory.transaction.','inventory.transaction.transfer','inventory.transaction.','inventory.transaction.stocktake','inventory.transaction.',
'inventory.transaction.dispose','inventory.transaction.','inventory.ajax.lots','inventory.ajax.balance','labels.evidence.sheet',
'labels.evidence.single','labels.remaining.sheet','labels.remaining.all','labels.remaining.single','debug.doc-probe','debug.file-upload','debug.file-keys',
'design.examples','register','login',
...
'analysts._form','analysts.create','analysts.edit','analysts.index','analysts.logs',
'analysts.show','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','changelogs.index','components.alert','components.application-logo',
'components.auth-session-status','components.breadcrumbs','components.button','components.card','components.confirm-dialog',
'components.danger-button','components.dropdown','components.dropdown-link','components.empty-state','components.form-field',
'components.form-stepper','components.form.input','components.icon','components.input-error','components.input-label',
'components.kpi-card','components.modal','components.nav-link','components.page-header','components.page-section',
'components.primary-button','components.responsive-nav-link','components.sample-status-badge','components.secondary-button','components.skeleton-table',
'components.stage-tabs','components.status-badge','components.tabs','components.text-input','components.timeline-status-badge',
'components.toast-container','dashboard','delivery.index','delivery.pdf.cover-letter','delivery.show',
'delivery.survey','design-examples','emails.test-notification','inventory.dashboard','inventory.items.form',
'inventory.items.index','inventory.items.lots','inventory.locations.form','inventory.locations.index','inventory.pdf.stock-card',
'inventory.stock-card','inventory.transactions.dispose','inventory.transactions.issue','inventory.transactions.receipt','inventory.transactions.stocktake',
'inventory.transactions.transfer','labels.evidence-sheet','labels.evidence-single','labels.remaining-sheet','labels.remaining-single',
'landing','layouts.app','layouts.guest','layouts.navigation','monitoring.environment.correction',
'monitoring.environment.index','monitoring.environment.manage','monitoring.instruments.index','monitoring.sensors.index','partials.label-section',
'partials.remaining-label-section','pdf.ba-penyerahan','pdf.berita-acara-penerimaan','pdf.environment-monthly','pdf.form-preparation',
'pdf.instrument-monthly','pdf.laporan-hasil-uji','pdf.settings-preview','pdf.weighing-monthly','process.index',
'process.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'pulse::dashboard','reports.monthly-logs','requests.create','requests.edit','requests.index',
'requests.partials.documents','requests.show','sample-processes._form','sample-processes.create','sample-processes.edit',
'sample-processes.form-document','sample-processes.index','sample-processes.report-document','sample-processes.report-lhu','sample-processes.show',
'samples.test','search.index','settings.blade-templates','settings.document-templates','settings.index',
'settings.partials.backup-maintenance','settings.partials.branding','settings.partials.documents','settings.partials.iku','settings.partials.localization-retention',
'settings.partials.monitoring-logging','settings.partials.notifications-security','settings.partials.numbering','statistics.index','tracking.index',
'tracking.result','vendor.pulse.dashboard','welcome','7224ff0b1fa42156c352216deff15b56::card','7224ff0b1fa42156c352216deff15b56::card-header',
...
'validation.custom.attribute-name.rule-name','tracking.page_title','tracking.breadcrumbs.tracking','tracking.breadcrumbs.result','tracking.actions.track_again',
'tracking.actions.manual_refresh','tracking.labels.progress_testing','tracking.labels.last_updated','tracking.labels.request_number','tracking.labels.investigator',
'tracking.labels.samples_count','tracking.labels.estimated_completion','tracking.labels.contact_info','tracking.labels.investigator_submitter','tracking.labels.lab_unit',
'tracking.stages_condensed.submitted','tracking.stages_condensed.processing','tracking.stages_condensed.completed','tracking.stages_condensed.delivered','tracking.stages_full.penerimaan',
'tracking.stages_full.preparasi','tracking.stages_full.pengujian_instrumen','tracking.stages_full.ttd_pimpinan','tracking.stages_full.penyerahan','tracking.badge_status.completed',
'tracking.badge_status.current','tracking.badge_status.pending','tracking.misc.investigator_name','tracking.misc.investigator_unit','tracking.misc.investigator_phone',
'tracking.misc.lab_address','tracking.misc.lab_phone','tracking.misc.lab_email',);
...
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','WHATSAPP_API_URL',
'WHATSAPP_API_KEY','VITE_APP_NAME',);
