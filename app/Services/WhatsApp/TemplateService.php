...
class TemplateService
{
    ...
    private const DEFAULTS = [
        ...
        'command' => [
            ...
            'STATUS_REPORT' => "📊 *Ringkasan Layanan Laboratorium*\n\n📁 *Total permintaan:* {request_total}\n🧪 *Total sampel:* {sample_grand_total}\n\n🔢 *Permintaan aktif:* {active_total}\n• Kaji ulang: {review_total}\n• Pengujian: {testing_total}\n• Siap diserahkan: {ready_total}\n\n🧫 *Sampel aktif:* {sample_total}\n✅ *Selesai / serah terima:* {completed_total}\n\n─────────────────\n_Update: {timestamp}_\nUntuk menelusuri permintaan tertentu, ketik `/resi {nomor_resi}`.",
        ...
        'auto_reply' => [
            'WELCOME' => "👋 Selamat datang di *Bot LPMF Tracking*.\n\nBot ini membantu Anda menelusuri permintaan pengujian dan menerima respons operasional laboratorium.\n\nKetik /help untuk melihat perintah yang tersedia.",
            'NO_COMMAND' => "Pesan Anda belum dikenali sebagai command.\n\nKetik /help untuk melihat format perintah yang tersedia.",
        ],
        'system' => [
    ...
    private const PLACEHOLDERS = [
        ...
        'command' => [
            ...
            'COMMAND_ERROR' => [],
            'STATUS_REPORT' => ['request_total', 'sample_grand_total', 'active_total', 'review_total', 'testing_total', 'ready_total', 'sample_total', 'completed_total', 'timestamp', 'nomor_resi'],
            'RESTART_SUCCESS' => [],
    ...
    public function getTemplateLabels(): array
    {
        return [
            ...
            'command' => [
                'HELP' => 'Panduan Command (/help)',
                'HELP_ADMIN' => 'Perintah Admin (tambahan)',
                ...
                'STATUS_REPORT' => 'Ringkasan Layanan (/status)',
