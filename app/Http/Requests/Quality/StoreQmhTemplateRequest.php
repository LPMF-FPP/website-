...
class StoreQmhTemplateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'layout_profile' => ['nullable', Rule::in([...QmhFrLayoutProfile::allowedProfiles(), 'table', 'non_table'])],
            'shell_mode' => ['nullable'],
            'orientation_policy' => ['nullable'],
            'show_signoff_footer' => ['nullable'],
            'logo_source' => ['nullable', Rule::in(QmhFrLayoutProfile::allowedLogoSources())],
            'logo_path' => ['nullable', 'string', 'max:255'],
            'declaration_header' => ['nullable'],
