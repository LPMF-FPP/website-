...
class TrackingController extends Controller
{
    ...
    {
        $stageOrder = ['penerimaan', 'kaji_ulang_sampel', 'preparasi', 'pengujian_instrumen', 'interpretasi_hasil', 'penyerahan'];
        ...
        $stageDefinitions = [
            ...
            'kaji_ulang_sampel' => [
                ...
                'description' => 'Kelengkapan administrasi dan kesesuaian sampel dikaji ulang sebelum proses teknis dilanjutkan.',
                'timestamp' => optional($testRequest->verified_at)->toDateTimeString(),
                'icon' => '🔎',
            ],
            'preparasi' => [
    ...
    private function getFallbackTrackingRecord(string $trackingNumber): ?array
    {
        $trackingDatabase = [
            'REQ-2025-0001' => [
                ...
                'current_status' => 'interpretasi_hasil',
                ...
                'tracking_stages' => [
                    ...
                    [
                        'stage' => 'interpretasi_hasil',
                        'title' => 'Interpretasi Hasil',
                        'description' => 'Hasil pengujian ditelaah, diinterpretasi, dan disiapkan sebagai keluaran resmi layanan.',
                        'timestamp' => '2025-09-23 14:20:00',
                        'status' => 'current',
                        'icon' => '✍️',
                    ],
                    [
            ...
            'DUMMY-RECEIPT-001' => [
                ...
                'submit_date' => '2026-03-08 09:00:00',
                'current_status' => 'pengujian_instrumen',
                'estimated_completion' => '2026-03-15 16:00:00',
                'samples_count' => 2,
                'tracking_stages' => [
                    [
                        'stage' => 'penerimaan',
                    ...
                    [
                        'stage' => 'kaji_ulang_sampel',
                        'title' => 'Kaji Ulang Sampel',
                        'description' => 'Kelengkapan administrasi dan kesesuaian sampel dikaji ulang sebelum proses teknis dilanjutkan.',
                        'timestamp' => '2026-03-09 08:10:00',
                        'status' => 'completed',
                        'icon' => '🔎',
                    ],
                    [
            ...
            'DUMMY-RECEIPT-002' => [
                ...
                'submit_date' => '2026-03-05 08:30:00',
                'current_status' => 'interpretasi_hasil',
                'estimated_completion' => '2026-03-14 10:00:00',
                'samples_count' => 3,
                'tracking_stages' => [
                    [
                        'stage' => 'penerimaan',
                    ...
                    [
                        'stage' => 'pengujian_instrumen',
                        'title' => 'Pengujian Instrumen',
                        'description' => 'Analisa instrumen telah diselesaikan untuk seluruh sampel.',
                        'timestamp' => '2026-03-08 15:45:00',
                        'status' => 'completed',
                        'icon' => '⚙️',
                    ],
                    [
                        'stage' => 'interpretasi_hasil',
                        'title' => 'Interpretasi Hasil',
                        'description' => 'Hasil pengujian telah diinterpretasi dan keluaran layanan sedang disiapkan untuk penyerahan.',
                        'timestamp' => '2026-03-13 09:10:00',
                        'status' => 'current',
                        'icon' => '✍️',
                    ],
                    [
                        'stage' => 'penyerahan',
                        'title' => 'Penyerahan',
                        'description' => 'Hasil pengujian akan diserahkan kepada pemohon setelah pengesahan selesai.',
                        'timestamp' => null,
                        'status' => 'pending',
                        'icon' => '📄',
                    ],
    ...
    private function buildCondensedPayload(array $trackingData): array
    {
        $mapStages = [
            ...
            'kaji_ulang_sampel' => 1,
            'preparasi' => 1,
            'pengujian_instrumen' => 2,
            'interpretasi_hasil' => 2,
            'penyerahan' => 3,
        ];
