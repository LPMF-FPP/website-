...
class SampleStatusBadge extends Component
{
    ...
    protected function getStatusColors(): array
    {
        return match ($this->sample->status->value) {
            ...
            'admin_pending', 'preparation_pending', 'instrumentation_pending', 'interpretation_pending' => ['bg-yellow-100', 'text-yellow-800'],

            'admin_in_progress', 'preparation_in_progress', 'instrumentation_in_progress', 'interpretation_in_progress' => ['bg-orange-100', 'text-orange-800'],

            'admin_done', 'preparation_done', 'instrumentation_done', 'interpretation_done' => ['bg-green-100', 'text-green-800'],
