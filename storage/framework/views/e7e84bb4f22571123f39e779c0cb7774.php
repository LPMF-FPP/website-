...
<div class="watermark avoid">RAHASIA</div>
  ...
  <table class="kv avoid">
    ...
    <tr><th>Deskripsi Singkat</th><td><?php echo e($samp?->short_description ?? '—'); ?></td></tr>
    <tr><th>Jumlah Sampel</th><td><?php echo e(($samp?->package_quantity ?? $samp?->quantity ?? 1)); ?> <?php echo e($samp?->unit ?? 'Unit'); ?></td></tr>
