...
<head>
<meta charset="UTF-8">
<title>Berita Acara Penyerahan — <?php echo e($req->request_number); ?></title>
<style>
...
<body>
  ...
  <div class="header">
    <?php if(file_exists(public_path('images/logo-tribrata-polri.png'))): ?>
      <img class="logo logo-left" src="<?php echo e(public_path('images/logo-tribrata-polri.png')); ?>" alt="">
    <?php endif; ?>
    <div class="center">
    ...
    <?php if(file_exists(public_path('images/logo-pusdokkes-polri.png'))): ?>
      <img class="logo logo-right" src="<?php echo e(public_path('images/logo-pusdokkes-polri.png')); ?>" alt="">
    <?php endif; ?>
  </div>

  <h1 class="title">Berita Acara Penyerahan</h1>
  <div style="text-align:center; margin:4px 0 8px; font-weight:700; font-size:11pt;"><?php echo e($baPenyerahanNumber); ?></div>

  <table class="meta-table">
    <tr><td class="label">Nomor Resi</td><td class="sep">:</td><td class="value nowrap"><strong><?php echo e($req->receipt_number ?? $req->request_number); ?></strong></td></tr>
    <tr><td class="label">Pelanggan</td><td class="sep">:</td><td class="value"><?php echo e($invName ?: '—'); ?> <?php if($invNrp): ?> — NRP/NIP: <?php echo e($invNrp); ?> <?php endif; ?></td></tr>
    <tr><td class="label">Unit/Satuan</td><td class="sep">:</td><td class="value"><?php echo e($inv?->jurisdiction ?? $req->unit ?? '—'); ?></td></tr>
    <tr><td class="label">Nama Tersangka</td><td class="sep">:</td><td class="value"><?php echo e($req->suspect_name ?? '—'); ?></td></tr>
  <tr><td class="label">Kode Sampel</td><td class="sep">:</td><td class="value"><?php echo e($allSampleCodesStr); ?></td></tr>
  <tr><td class="label">Nomor LHU</td><td class="sep">:</td><td class="value"><?php echo e($allLhuNumbersStr); ?></td></tr>
    <tr><td class="label">Dasar Permohonan</td><td class="sep">:</td><td class="value"><?php echo e($basisText); ?></td></tr>
  ...
  <div class="section">
    ...
    <table class="tbl-sampel">
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $samples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php
          ...
          ?>
          <tr><td class="col-no"><?php echo e($i+1); ?></td><td><strong><?php echo e($code); ?></strong> — Uji: <?php echo e($methodsStr); ?></td></tr>
  ...
  <div class="section">
    ...
    <table>
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $samples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php $code = $s->sample_code ?? $s->sample_name ?? '—'; ?>
          <tr><td><?php echo e($code); ?></td><td><?php echo e($calcSisa($s)); ?></td></tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <tr>
      ...
      <td class="sigcell">
        <div class="sigbox">
          ...
          <div><?php echo e($invName ?: '—'); ?></div>
          <div class="small muted">NRP <?php echo e($invNrp ?? '—'); ?></div>
        </div>
      </td>
    </tr>
  </table>
  ...
  <div class="footer">
    <div class="small">Kode Dokumen: BA-Penyerahan/<?php echo e($req->request_number); ?></div>
    <div class="small">Dicetak pada: <?php echo e($today->translatedFormat('d F Y H:i')); ?> WIB</div>
...
<?php /**PATH C:\Users\Farma\pusdokkes-subunit\resources\views/pdf/ba-penyerahan.blade.php ENDPATH**/ ?>