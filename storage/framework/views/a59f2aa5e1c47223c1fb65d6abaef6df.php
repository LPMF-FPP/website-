...
<body>
  ...
  <table class="meta-table">
    <tr><td class="label">Nomor Permintaan (Lab)</td><td class="sep">:</td><td class="value nowrap"><strong><?php echo e($req->request_number); ?></strong></td></tr>
    <tr><td class="label">Nomor BA</td><td class="sep">:</td><td class="value"><?php echo e($baNumber); ?></td></tr>
