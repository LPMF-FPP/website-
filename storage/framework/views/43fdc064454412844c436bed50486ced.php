    ...
    <tr>
      <td style="width:78px">
        <?php if(file_exists(public_path('images/logo-tribrata-polri.png'))): ?>
          <img src="<?php echo e(public_path('images/logo-tribrata-polri.png')); ?>" style="height:54px">
        <?php endif; ?>
      </td>
      <td class="c">
      ...
      <td style="width:78px; text-align:right">
        <?php if(file_exists(public_path('images/logo-pusdokkes-polri.png'))): ?>
          <img src="<?php echo e(public_path('images/logo-pusdokkes-polri.png')); ?>" style="height:54px">
        <?php endif; ?>
      </td>
    </tr>
  </table>
    ...
    <tr class="signrow">
      ...
      <td class="lcol" style="text-align:center;">
        ...
        <div style="height:60px; margin: 2px 0;">
          <?php if($hasSign): ?><img src="<?php echo e($signPath); ?>" style="height:58px"><?php endif; ?>
        </div>
...
<?php /**PATH C:\Users\Farma\pusdokkes-subunit\resources\views/pdf/laporan-hasil-uji.blade.php ENDPATH**/ ?>