...
<body>
  ...
  <div class="header">
    <?php if(file_exists(public_path('images/logo-tribrata-polri.png'))): ?>
      <img class="logo logo-left" src="<?php echo e(public_path('images/logo-tribrata-polri.png')); ?>" alt="Logo Polri">
    <?php endif; ?>
    <div class="center">
    ...
    <?php if(file_exists(public_path('images/logo-pusdokkes-polri.png'))): ?>
      <img class="logo logo-right" src="<?php echo e(public_path('images/logo-pusdokkes-polri.png')); ?>" alt="Logo Pusdokkes">
    <?php endif; ?>
  </div>

  <h1 class="title">Berita Acara Penerimaan Sampel</h1>
  <div class="subtitle">Nomor Permintaan: <b><?php echo e($request->request_number); ?></b></div>
  ...
  <table class="meta-table">
    <tr><td class="label">Nomor Resi</td><td class="sep">:</td><td class="value nowrap"><strong><?php echo e($receiptNumber); ?></strong></td></tr>
    <tr><td class="label">Nomor Surat Permintaan</td><td class="sep">:</td><td class="value"><?php echo e($request->case_number ?? '-'); ?></td></tr>
    <tr><td class="label">Ditujukan Kepada</td><td class="sep">:</td><td class="value"><?php echo e($request->to_office ?? 'Kepala Sub Satker Farmapol Pusdokkes Polri'); ?></td></tr>
    <tr><td class="label">Penyerah Sampel</td><td class="sep">:</td><td class="value"><?php echo e(trim(($request->investigator->rank ?? '').' '.($request->investigator->name ?? ''))); ?> (NRP: <?php echo e($request->investigator->nrp ?? '-'); ?>)</td></tr>
    <tr><td class="label">Unit/Satuan</td><td class="sep">:</td><td class="value"><?php echo e($request->investigator->jurisdiction ?? '-'); ?></td></tr>
    <tr><td class="label">Jumlah Sampel</td><td class="sep">:</td><td class="value"><strong><?php echo e($request->samples->count()); ?></strong> sampel</td></tr>
    <tr><td class="label">Jenis Pengujian</td><td class="sep">:</td><td class="value"><?php echo e($testsSummary ?: '-'); ?></td></tr>
  </table>
  ...
  <table class="list-table">
    ...
    <tbody>
      ...
      <tr>
        <td class="col-name"><b><?php echo e($sample->short_description ?? '—'); ?></b></td>
        <td class="col-qty"><?php echo e($formatQtyUnit($sample)); ?></td>
...
<?php /**PATH /home/lpmf-dev/website-/resources/views/pdf/berita-acara-penerimaan.blade.php ENDPATH**/ ?>