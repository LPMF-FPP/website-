...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumbs','data' => ['items' => [],'class' => 'small text-xs','navClass' => 'mb-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([]),'class' => 'small text-xs','navClass' => 'mb-1']); ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(url()->current()); ?>" class="btn btn-outline-secondary btn-sm px-3 inline-flex items-center rounded border border-gray-300 py-1.5 text-sm font-semibold text-gray-700 hover:border-primary-500 hover:text-primary-700">
                Refresh
            </a>
        </div>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php /**PATH /home/lpmf-dev/website-/resources/views/dashboard.blade.php ENDPATH**/ ?>