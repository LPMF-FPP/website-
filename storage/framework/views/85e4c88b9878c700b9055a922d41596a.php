...
<?php endif; ?>
            ...
            <?php if(session('status') === 'password-updated'): ?>
                <p id="password-updated-flash" class="text-sm text-gray-600"><?php echo e(__('Saved.')); ?></p>
                <?php $__env->startPush('scripts'); ?>
                <script>
                    setTimeout(()=>{
                        const el = document.getElementById('password-updated-flash');
                        if(el) el.remove();
                    }, 2000);
                </script>
                <?php $__env->stopPush(); ?>
...
<?php /**PATH C:\Users\Farma\pusdokkes-subunit\resources\views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>