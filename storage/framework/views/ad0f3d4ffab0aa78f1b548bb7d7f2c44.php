                        ...
                        <div class="pointer-events-none opacity-0 group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity duration-150 ease-out absolute right-0 top-full mt-2 w-[90vw] max-w-5xl z-[80]">
                            <div class="bg-white shadow-2xl ring-1 ring-black/5 rounded-2xl p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    ...
                                    <a href="<?php echo e(route('database.index')); ?>" class="group flex items-start gap-3 p-3 rounded-xl border border-primary-100 hover:border-primary-200 hover:bg-primary-50 transition">
                                        <div class="shrink-0 inline-flex w-10 h-10 items-center justify-center rounded-xl bg-primary-100 text-primary-600">
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => ''.e(route('database.index')).'','active' => request()->routeIs('database.*')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('database.index')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('database.*'))]); ?>
                            Database
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald69b52d99510f1e7cd3d80070b28ca18)): ?>
