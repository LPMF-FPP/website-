...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => '📊 Statistik dan Rekap Data','breadcrumbs' => [[ 'label' => 'Statistik' ]]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => '📊 Statistik dan Rekap Data','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([[ 'label' => 'Statistik' ]])]); ?>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900"><?php echo e($requests_this_month); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900"><?php echo e($samples_this_year); ?></p>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900"><?php echo e($active_substances_detected); ?></p>
                            <?php
                                $uniqueActiveSubstances = $activeSubstanceBreakdown['unique_total'] ?? count($activeSubstanceBreakdown['labels'] ?? []);
                            ?>
                            <p class="text-xs text-gray-500 mt-1"><?php echo e($uniqueActiveSubstances); ?> jenis unik</p>
                            <?php if($activeSubstanceBreakdown['fallback'] ?? false): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.skeleton-table','data' => ['columns' => 3,'rows' => 6]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['columns' => 3,'rows' => 6]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg h-full">
                <div class="p-6 flex flex-col h-full">
                    ...
                    <div class="mt-4 text-center text-sm text-gray-600">
                        ...
                        ?>
                        <?php if($topActiveSubstances->isNotEmpty()): ?>
                            <p>Zat aktif terbanyak: <?php echo e($topActiveSubstances->pluck('label')->implode(', ')); ?></p>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($requests_this_month); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e(\App\Models\TestRequest::whereYear('created_at', now()->year)->count()); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">32/bulan</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-<?php echo e($requests_this_month >= 32 ? 'green' : 'yellow'); ?>-100 text-<?php echo e($requests_this_month >= 32 ? 'green' : 'yellow'); ?>-800">
                                        <?php echo e($requests_this_month >= 32 ? 'Di Atas Target' : 'Normal'); ?>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e(\App\Models\Sample::whereMonth('created_at', now()->month)->count()); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($samples_this_year); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">200/tahun (IKU)</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-<?php echo e($samples_this_year >= 160 ? 'green' : 'yellow'); ?>-100 text-<?php echo e($samples_this_year >= 160 ? 'green' : 'yellow'); ?>-800">
                                        <?php echo e($samples_this_year >= 160 ? 'Mendekati Target' : 'Perlu Peningkatan'); ?>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($active_substances_detected); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($active_substances_detected); ?></td>
    ...
    <script>
        ...
        function loadUserOriginChart() {
            fetch('<?php echo e(route("statistics.data")); ?>?type=user_origin')
                .then(response => {
                    if (!response.ok) {
        ...
        function loadActiveSubstancesChart() {
            ...
            fetch('<?php echo e(route("statistics.data")); ?>?type=active_substances')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
        ...
        function loadSuspectGenderChart() {
            ...
            fetch('<?php echo e(route("statistics.data")); ?>?type=suspect_gender')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
        ...
        function loadSuspectAgeChart() {
            ...
            fetch('<?php echo e(route("statistics.data")); ?>?type=suspect_age')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
        ...
        function loadMonthlyRequestsChart() {
            ...
            fetch('<?php echo e(route("statistics.data")); ?>?type=monthly_requests')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
        ...
        function loadMonthlySamplesChart() {
            ...
            fetch('<?php echo e(route("statistics.data")); ?>?type=monthly_samples')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
        ...
        function exportChart(type) {
            const url = '<?php echo e(route("statistics.export")); ?>?type=' + type;
...
<?php endif; ?>
<?php /**PATH C:\Users\Farma\pusdokkes-subunit\resources\views/statistics/index.blade.php ENDPATH**/ ?>