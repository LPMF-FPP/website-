...
### v1.1.6 (10 Januari 2026)

#### Enhancement: Semantic Versioning Constraint

**Updated on 2026-01-10**

Applied strict semantic versioning constraint across all project documentation to prevent version number overflow and maintain consistency.
...
**Retroactive Version Fixes:**

Corrected existing version numbers to comply with new constraint:

- ~~v1.0.9.1~~ → **v1.1.0** (WhatsApp bugfix + editable templates)
- ~~v1.0.9~~ → **v1.1.1** (Party Mode documentation)
- ~~v1.0.11~~ → **v1.1.2** (UI/UX Phase 1: Critical fixes)
- ~~v1.0.12~~ → **v1.1.3** (UI/UX Phase 2: Component creation)
- ~~v1.0.13~~ → **v1.1.4** (UI/UX Phase 3: Confirm dialog deployment)
- ~~v1.0.14~~ → **v1.1.5** (UI/UX Phase 4: Form stepper integration)

**Files Modified:**

- `AGENTS.md` - Added versioning rules to section 7 (Documentation & Change Tracking)
- `WALKTHROUGH.md` - Fixed all version headers (7 versions corrected)
- `todos.md` - Updated version references in phase summaries
...
- `2eb5e0c` - Applied semantic versioning constraint with retroactive fixes
